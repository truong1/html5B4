...
compiler_path = os.path.join(extdir,'closure-compiler-v20170521.jar')
...
def checkDependencies():
    ...
    if not os.path.exists(compiler_path):
        ...
        zippedFile.extract('closure-compiler-v20170521.jar',extdir)
        zippedFile.close()
        print ('Cleanup')
        os.unlink(zip_path)
        os.rename(os.path.join(extdir,'closure-compiler-v20170521.jar'), compiler_path)
